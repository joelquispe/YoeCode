	...
	return (
		<>
			<div className=" h-screen flex flex-col items-center justify-center w-screen">
				<h1 className="font-bold text-7xl text-secondary ">YoeCode</h1>
				<p className="text-white font-medium text-center w-8/12 mt-11">
				...
				<div className="grid grid-cols-2 sm:flex gap-8 lg:gap-10 mt-16">
				...
				<a href='https://api.whatsapp.com/send?phone=51960765839&text=%F0%9F%98%80' className="scale-infinite rounded-lg absolute right-0 bottom-0 mb-4 mr-4 bg-slate-900 w-[260px] h-28 p-3 shadow-2xl">
